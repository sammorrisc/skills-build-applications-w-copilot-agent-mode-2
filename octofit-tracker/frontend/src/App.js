    ...
    <Router>
      ...
      <div className="container">
        <Routes>
          ...
          <Route path="/" element={<div className="text-center mt-5"><h1 className="display-4">Welcome to <span className="text-primary">Octofit Tracker</span>!</h1><p className="lead">Track your fitness, join teams, and climb the leaderboard.</p></div>} />
        </Routes>
      </div>
    </Router>
  );
